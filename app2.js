...
//instanciar el objeto de web3
    ...
    const web3 = new Web3('https://ropsten.infura.io/v3/c5f94f23797c47ecb5fb633740ae8ezz')
//declarar las address publicas con las cuentas que vamos a interactuar
const address1 = '0x4AF92bF32A3824641c813013e108e5C1aAD90Czz';//
//const address1 = "";//
const address2 = '0xEd9333ad25b09748144dAAd34455252411b335zz';//
//const address2 = "";//

//declarar las claves privadas en un objeto tipo buffer para poder firmar las transacciones
const addresskey1 = new Buffer.from('201059fbefe95a7e28ceb4955dd3afbe2bf0455bc7473c73649d90ceaf336azz', 'hex');
const addresskey2 = new Buffer.from('4b7630d9c4e23d24f259c02feb2d3224c7834287e2d8ceb819dc74629b274azz', 'hex');
